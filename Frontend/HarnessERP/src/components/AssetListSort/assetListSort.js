...
const AssetListSort = ({ onClose, setSortBy, setPreviouslySelectedSort,previousSort}) => {
                ...
                <View style={styles.popup}>
                   ...
                   >
                        ...
                        <View style={styles.radioButton}>
                           {selectedOption === 'acquisitionDateNewestFirst' && <View style={styles.radioButtonInner} />}
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <View style={styles.radioButton}>
                           {selectedOption === 'assetCode' && <View style={styles.radioButtonInner} />}
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <View style={styles.radioButton}>
                           {selectedOption === 'valueLowToHigh' && <View style={styles.radioButtonInner} />}
                        </View>
                    </TouchableOpacity>
                    ...
                    >
                        ...
                        <View style={styles.radioButton}>
                        {selectedOption === 'valueHighToLow' && <View style={styles.radioButtonInner} />}
                    </View>
                    </TouchableOpacity>
